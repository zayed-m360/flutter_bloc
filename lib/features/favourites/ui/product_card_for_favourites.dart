...
class ProductCardforFavourites extends StatelessWidget {
  final ProductDataModel productDataModel;
  const ProductCardforFavourites({super.key, required this.productDataModel});

  @override
  Widget build(BuildContext context) {
    FavouritesBloc favouritesBloc = BlocProvider.of<FavouritesBloc>(context);
    return Container(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        favouritesBloc.add(FavoritesRemoveItemEvent(productDataModel: productDataModel));
                      },
                    ),
                  ],
                ),
